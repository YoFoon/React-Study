...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory }, _react2.default.createElement(_reactRouter.Route, { path: '/', component: _index2.default }), _react2.default.createElement(_reactRouter.Route, { path: '/depail/:title', component: _index4.default })), document.getElementById('app'));
	...
	var EveryBlog = function (_React$Component) {
	    ...
	    _createClass(EveryBlog, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'eachBlog' }, _react2.default.createElement('h2', { className: 'title' }, _react2.default.createElement(_reactRouter.Link, { to: "/depail/" + item._id }, item.title)), _react2.default.createElement('article', { dangerouslySetInnerHTML: { __html: item.post } }), _react2.default.createElement('div', { className: 'meta' }, _react2.default.createElement('span', { className: 'time' }, item.time.day), _react2.default.createElement('span', { className: 'tag' }, 'on', _react2.default.createElement('a', null, item.tags)), _react2.default.createElement('span', { className: 'read' }, item.read, ' Read')));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Article = function (_Component) {
	    ...
	    _createClass(Article, [{
	        ...
	        value: function render() {
	            var item = this.props.item;
	            return _react2.default.createElement(_row2.default, null, _react2.default.createElement(_col2.default, { span: 22, offset: 1, className: 'pt2 pb2' }, _react2.default.createElement('div', { className: 'ds-thread', 'data-thread-key': 'YoFoon', 'data-title': item.title, 'data-url': "http://localhost:3000/view/blog/#/depail/" + item._id })));
	        }
	    }]);
